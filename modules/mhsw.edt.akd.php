...
function frmAkademik() {
  ...
  // ori : $optdsn = GetOption2('dosen', "concat(Gelard, '.', Nama, ',', Gelar)", 'Nama', $datamhsw['PenasehatAkademik'], "Homebase='$datamhsw[ProdiID]'", 'Login');
  $optdsn = GetOption2('dosen', "concat(Gelard, '.', Nama, ',', Gelar)", 'Nama', $datamhsw['PenasehatAkademik'], '', 'Login');
