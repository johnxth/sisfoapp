...
function DftrUsr() {
  ...
  echo "<p><table class=box cellspacing=1 cellpadding=4>
    ...
    <input type=hidden name='mnux' value='modules/sysusr'>
...
function DaftarUsr() {
  if (!empty($_SESSION['LevelID'])) {
    ...
    $a = "<p><table class=box cellspacing=1 cellpadding=4>
      <tr><td class=ul colspan=5><a href='?mnux=modules/sysusr&gos=UsrEdt&LevelID=$_SESSION[LevelID]&md=1'>Tambah User</a></td></tr>
    ...
    while ($w = _fetch_array($r)) {
      ...
      $a .= "<tr><td $c>$n</td>
        <td $c><a href='?mnux=modules/sysusr&gos=UsrEdt&LevelID=$_SESSION[LevelID]&md=0&Lgn=$w[Login]'><img src='img/edit.png' border=0>
        $w[Login]</a></td>
        <td $c>$w[Nama]</td>
        <td $c>$w[ProdiID]&nbsp;</td>
        <td $c align=center><img src='img/book$w[NA].gif'></td>
				<td $c align=center><a href='?mnux=modules/sysusr&gos=dltUsrCek&LevelID=$_SESSION[LevelID]&Lgn=$w[Login]'><img src='img/del.gif'></td>
        </tr>";
    }
    return $a ."</table></p>";
  }
...
function dltUsrCek(){
	...
	echo Konfirmasi("Delete User", "Yakin Anda ingin menghapus user : <br />
									...
									<input type=button name='hapus' value='Delete User' onClick=\"location='?mnux=modules/sysusr&gos=dltUsr&Lgn=$Login'\">");
}
