...
function HeaderDosen($dsn) {
  ...
  if ($_SESSION['_LevelID'] == $_LevelDosen) {
    $opt = "$dsn[Login], $dsn[Nama], $dsn[Gelar]";
  }
  else {
  ...
  <tr>
	<td class=inp>Kode Dosen</td>
	<td class=ul>$dsn[Login]</td>
    <td class=inp>Nama</td>
	<td class=ul>$opt</td></tr>
  <tr>
	<td class=inp>Status</td>
	<td class=ul>$dsn[SD]</td>
    <td class=inp>Homebase</td>
	<td class=ul>$dsn[HB] ($dsn[Homebase])</td></tr>
  </form></table></p>";
}
