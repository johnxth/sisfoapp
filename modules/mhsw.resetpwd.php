...
function TampilkanFormHeaderResetPasswordMahasiswa() {
  ...
  <tr><td class=inp>NIM</td><td class=ul><input type=text id='MhswID' name='MhswID' value='$_SESSION[MhswID]' size=20 maxlength=50>&nbsp;&nbsp;<input type=button name=paslama value='Lihat Password Lama' onClick='carikelajax(this)'></td></tr>
