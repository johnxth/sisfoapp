...
include_once "modules/dosen.hdr.editdata.php";
...
function CariDosen() {
 // TampilkanFilterDosen('dosen', 1);
  FormLast();
  DaftarDosen('modules/dosen.editdata', "gos=DsnEdt&md=0&dsnid=$_SESSION[_Login]", "NIDN,Nama,Gelar,Homebase,Telephone,Alamat");
}
...
function FormLast(){
  ...
  echo "<div id='last' style='display:none'>
        ...
        <input type=hidden name='mnux' value='modules/dosen.editdata'>
...
function DsnAdd($mnux='modules/dosen.editdata', $gos='DsnAddSav', $sub='') {
  $md = $_REQUEST['md']+0;
  if ($md == 0) {
    ...
    $hm = "<tr><td >Prodi Homebase</td><td class=ul><select name='Homebase'>$Homebase</select></td></tr>";
    $jdl = "Tambah Dosen";
  ...
  <tr><td >Login/NIP</td><td class=ul>$_strdsnid</td></tr>
  <tr><td >NIDN</td><td class=ul><input type=text name='NIDN' value='$w[NIDN]' size=20 maxlength=50>
    Nomer Induk Dosen Nasional</td></tr>
  <tr><td >Nama Dosen</td><td class=ul><input type=text name='Nama' value='$w[Nama]' size=40 maxlength=50></td></tr>
  <tr><td >Gelar</td><td class=ul><input type=text name='Gelar' value='$w[Gelar]' size=$0 maxlength=100></td></tr>
  ...
  <tr><td >Jenis Kelamin</td><td class=ul>$radkel</td></tr>
  <tr><td >Agama</td><td class=ul><select name='AgamaID'>$optagm</select></td></tr>
  <tr><td ># Telepon</td><td class=ul><input type=text name='Telephone' value='$w[Telephone]' size=40 maxlength=50></td></tr>
  <tr><td ># Ponsel</td><td class=ul><input type=text name='Handphone' value='$w[Handphone]' size=40 maxlength=50></td></tr>
  <tr><td >E-mail</td><td class=ul><input type=text name='Email' value='$w[Email]' size=40 maxlength=50></td></tr>

  <tr><td >Program Studi</td><td class=ul>$optprodi</td></tr>
  <tr><td >Tidak aktif?</td><td class=ul><input type=checkbox name='NA' value='Y' $_na></td></tr>
  <tr><td colspan=2><input type=submit name='Simpan' value='Simpan'>
    <input type=reset name='Reset' value='Reset'>
    <input type=button name='Batal' value='Batal' onClick=\"location='?mnux=modules/dosen.editdata&gos=&$snm=$sid'\"></td></tr>
  </form></table></p>";
}
...
function TampilkanMenuEditDosen($w) {
  ...
  for ($i = 0; $i < sizeof($arrMenuDosen); $i++) {
    ...
    echo "<td $c><a href='?mnux=modules/dosen.editdata&gos=$mn[1]&dsnid=$w[Login]&dsnsub=$mn[2]'>$mn[0]</a></td>";
  }
  echo "</tr></table></p>";
}
function DsnEdt() {
...
function DsnEdtPribadi() {
  $_REQUEST['md']+0;
  DsnAdd('modules/dosen.editdata', 'DsnEdtPribadiSav', 'DsnEdtPribadi');
}
...
function DsnEdtAkademik() {
  ...
  <tr><td >Mulai Bekerja</td><td class=ul>$TglBekerja</td></tr>
  <tr><td >Status Dosen</td><td class=ul><select name='StatusDosenID'>$StatusDosen</select></td></tr>
  <tr><td >Status Kerja</td><td class=ul><select name='StatusKerjaID'>$StatusKerja</select></td></tr>
  <tr><td >Prodi Homebase</td><td class=ul><select name='Homebase'>$Homebase</select></td></tr>
  <tr><td >Mengajar di Prodi</td><td class=ul>$_ProdiID</td></tr>
  <tr><td >Kode Instansi Induk</td><td class=ul><input type=text name='InstitusiInduk' value='$w[InstitusiInduk]' size=10 maxlength=10></td></tr>
  <tr><td >Lulus Perg. Tinggi</td><td class=ul><input type=text name='LulusanPT' value='$w[LulusanPT]' size=50 maxlength=50></td></tr>
  <tr><td >Jenjang Pendidikan Tertinggi</td><td class=ul><select name='JenjangID'>$Jenjang</select></td></tr>
  <tr><td >Keilmuan</td><td class=ul><input type=text name='Keilmuan' value='$w[Keilmuan]' size=40 maxlength=100></td></tr>  
...
function DsnEdtJabatan() {
  ...
  <tr><td >Jabatan Akademik</td><td class=ul><select name='JabatanID'>$Jabatan</select></td></tr>
  <tr><td >Jabatan Dikti</td><td class=ul><select name='JabatanDiktiID'>$JabatanDikti</select></td></tr>
  <tr><td >Golongan</td><td class=ul><select name='GolonganID'>$optgol</select></td></tr>
  <tr><td >Tunjangan Ikatan</td><td class=ul><select name='IkatanID'>$optikt</select></td></tr>
  
  <tr><td class=ul colspan=2><b>Bank</b></td></tr>
  <tr><td >Nama Bank</td><td class=ul><input type=text name='NamaBank' value='$w[NamaBank]' size=50 maxlength=50></td></tr>
  <tr><td >Nama Akun</td><td class=ul><input type=text name='NamaAkun' value='$w[NamaAkun]' size=50 maxlength=50></td></tr>
  <tr><td >Nomer Akun</td><td class=ul><input type=text name='NomerAkun' value='$w[NomerAkun]' size=50 maxlength=50></td></tr>
...
function DsnEdtPendidikan() {
  ...
  <tr><td >Nomor Urut</td><td class=ul><input type=text name='Nomor' value='$w_[Nomor]' size=4 maxlength=3></td></tr>
  <tr><td >Gelar</td><td class=ul><input type=text name='Gelar' value='$w_[Gelar]' size=10 maxlength=10></td></tr>
  <tr><td >Jenjang</td><td class=ul><select name='JenjangID'>$Jenjang</select></td></tr>
  <tr><td >Tanggal Lulus Ijasah</td><td class=ul>$Tglijazah</td></tr>
  <tr><td >Kode P.T</td><td class=ul><input type=text name='AsalPT' value='$PT[PerguruanTinggiID]' size=10 maxlength=10></td></tr></td></tr>
  <tr><td >Kode Asal P.T</td><td class=ul><input type=text name='NamaPT' value='$PT[Nama]' size=50> <a href='javascript:caript(data)'>Cari</a></td></tr>
  <tr><td >Negara</td><td class=ul><input type=text name='NamaNegara' value='$w_[NamaNegara]' size=30 maxlength=50></td></tr>
  <tr><td >Benua</td><td class=ul><select name='KodeBenua'>$NoBenua</select></td></tr>
  <tr><td >Bidang Ilmu</td><td class=ul><input type=text name='BidangIlmu' value='$w_[BidangIlmu]' size=40 maxlength=></td></tr>
  <tr><td >Prodi DIKTI</td><td class=ul><input type=text name='Prodidosen' value='$w_[Prodi]' size=40 maxlength=></td></tr>
  
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen.editdata&gos=DsnEdt&dsnid=1001&dsnsub=TampilPendidikan'\"></td></tr>
  </form></table>";
  //<tr><td >Negara</td><td class=ul><select name='NamaNegara'>$Negara</select></td></tr>
}
...
function TampilKerjaDsn1(){
  ...
  $lst->pageactive = "=PAGE=";
  $lst->pages = "<a href='?mnux=modules/dosen.editdata&gos=&dsnpage==PAGE='>=PAGE=</a>";
  ...
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen.editdata&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn&dsnsub1=DsnEdtPekerjaan'>Tambah Pekerjaan</td></tr>
    <tr>
	  <th class=ttl>#</th>
  ...
  $lst->detailfmt = "<tr>
	  <td  width=18 align=right>=NOMER=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/dosen.editdata&gos=DsnEdt&md=0&dpid==DosenPekerjaanID=&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn&dsnsub1=DsnEdtPekerjaan\"><img src='img/edit.png' border=0>
      </a></td>
...
function TampilTelitiDsn1(){
  ...
  $lst->fields = "* ";
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen.editdata&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn&dsnsub1=DsnEdtPenelitian'>Tambah Penelitian</td></tr>
    <tr>
	  <th class=ttl>#</th>
	  <th class=ttl>Edit</th>
  ...
  $lst->detailfmt = "<tr>
	  <td  width=18 align=right>=NOMER=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/dosen.editdata&gos=DsnEdt&md=0&dlid==DosenPenelitianID=&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn&dsnsub1=DsnEdtPenelitian\"><img src='img/edit.png' border=0>
      </a></td>
...
function DsnEdtPenelitian() {
  ...
  <tr><td class=ul colspan=2><b>$jdl</b></td></tr>
  <tr><td >Judul Penelitian</td><td class=ul><input type=text name='penelitian' value='$w[NamaPenelitian]' size=20 maxlength=100></td></tr>

    
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen.editdata&gos=DsnEdt&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn'\"></td></tr>
  </form></table>";
}
...
function TampilPendidikan1(){
  ...
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen.editdata&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilPendidikan&dsnsub1=DsnEdtPendidikan'>Tambah Pendidikan</td></tr>
    <tr>
	  <th class=ttl>#</th>
	  <th class=ttl>Edit</th>
  ...
  $lst->detailfmt = "<tr>
	  <td  width=18 align=right>=Nomor=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/dosen.editdata&gos=DsnEdt&md=0&dsnid=$_SESSION[dsnid]&dsnsub=TampilPendidikan&dsnsub1=DsnEdtPendidikan&DosenPendidikanID==DosenPendidikanID=\"><img src='img/edit.png' border=0>
      </a></td>
...
function DsnEdtPekerjaan() {
  ...
  <tr><td class=ul colspan=2><b>$jdl</b></td></tr>
  <tr><td >Nama Institusi</td><td class=ul><input type=text name='Institusi' value='$w[Institusi]' size=20 maxlength=100></td></tr>
  <tr><td >Jabatan</td><td class=ul><input type=text name='Jabatan' value='$w[Jabatan]' size=20 maxlength=50></td></tr>
  <tr><td >Alamat Institusi</td><td class=ul><input type=text name='Alamat' value='$w[Alamat]' size=30 maxlength=100></td></tr>
  <tr><td >Kota</td><td class=ul><input type=text name='Kota' value='$w[Kota]' maxlength=50 size=30></td></tr>
  <tr><td >Kodepos</td><td class=ul><input type=text name='Kodepos' value='$w[Kodepos]' size=10 maxlength=10></td></tr>
  <tr><td >Telepon</td><td class=ul><input type=text name='Telepon' value='$w[Telepon]' size=10 maxlength=10></td></tr>
  <tr><td >Fax</td><td class=ul><input type=text name='Fax' value='$w[Fax]' size=10 maxlength=10></td></tr>
    
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen.editdata&gos=DsnEdt&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn'\"></td></tr>
  </form></table>";
}
...
function DsnEdtPengajaran() {
  ...
  $lst->pageactive = "=PAGE=";
  $lst->pages = "<a href='?mnux=modules/dosen.editdata&gos=DsnEdt&dsnajarpage==PAGE='>=PAGE=</a>";
  $lst->tables = "jadwal j
