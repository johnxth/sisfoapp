  ...
  if ($md == 0) {
    ...
    if (empty($ada)) {
     ...
     // $_SESSION['dsnkeycr'] = "Login";
      ...
      Pilihan: <a href='?mnux=modules/dosen.editdata&gos=DsnAdd&md=1'>Tambah Dosen</a> |
      <a href='?mnux=modules/dosen.editdata&gos='>Kembali ke Daftar Dosen</a>");
  }
}
// *** Edit Dosen ***
function TampilkanHeaderDosenEdit($w) {
  ...
  <tr><td class=ul>Pilihan:</td><td class=ul><a href='?mnux=modules/dosen.editdata&gos=&sub='>Kembali ke Daftar Dosen</a></td></tr>
  </table></p>";
}
