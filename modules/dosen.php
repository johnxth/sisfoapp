...
include_once "modules/dosen.hdr.php";
...
function CariDosen() {
  ...
  echo "<a href=?mnux=modules/dosen.cetak>Cetak</a>";
  DaftarDosen('modules/dosen', "gos=DsnEdt&md=0&dsnid==Login=", "NIDN,Nama,Gelar,Homebase,Telephone,Alamat");
}
...
function FormLast(){
  ...
  echo "<div id='last' style='display:none'>
        ...
        <input type=hidden name='mnux' value='modules/dosen'>
...
function DsnAdd($mnux='modules/dosen', $gos='DsnAddSav', $sub='') {
  $md = $_REQUEST['md']+0;
  if ($md == 0) {
  ...
  <tr><td colspan=2><input type=submit name='Simpan' value='Simpan'>
    ...
    <input type=button name='Batal' value='Batal' onClick=\"location='?mnux=modules/dosen&gos=&$snm=$sid'\"></td></tr>
  </form></table></p>";
}
...
function DsnAddSav($gos='DsnEdt') {
  ...
  if ($md == 0) {
    ...
    if (empty($ada)) {
      ...
      echo "<script>window.location = '?mnux=modules/dosen';</script>";
    }
      ...
      Pilihan: <a href='?mnux=modules/dosen&gos=DsnAdd&md=1'>Tambah Dosen</a> |
      <a href='?mnux=modules/dosen&gos='>Kembali ke Daftar Dosen</a>");
  }
}
// *** Edit Dosen ***
function TampilkanHeaderDosenEdit($w) {
  ...
  <tr><td class=ul>Pilihan:</td><td class=ul><a href='?mnux=modules/dosen&gos=&sub='>Kembali ke Daftar Dosen</a></td></tr>
  </table></p>";
}
function TampilkanMenuEditDosen($w) {
  ...
  for ($i = 0; $i < sizeof($arrMenuDosen); $i++) {
    ...
    echo "<td $c><a href='?mnux=modules/dosen&gos=$mn[1]&dsnid=$w[Login]&dsnsub=$mn[2]'>$mn[0]</a></td>";
  }
  echo "</tr></table></p>";
}
function DsnEdt() {
...
function DsnEdtPribadi() {
  $_REQUEST['md']+0;
  DsnAdd('modules/dosen', 'DsnEdtPribadiSav', 'DsnEdtPribadi');
}
...
function DsnEdtPendidikan() {
  ...
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen&gos=DsnEdt&dsnid=1001&dsnsub=TampilPendidikan'\"></td></tr>
  </form></table>";
...
function TampilKerjaDsn1(){
  ...
  $lst->pageactive = "=PAGE=";
  $lst->pages = "<a href='?mnux=modules/dosen&gos=&dsnpage==PAGE='>=PAGE=</a>";
  ...
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn&dsnsub1=DsnEdtPekerjaan'>Tambah Pekerjaan</td></tr>
    <tr>
	  <th class=ttl>#</th>
  ...
  $lst->detailfmt = "<tr>
      ...
      <td class=cna=NA=><a href=\"?mnux=modules/dosen&gos=DsnEdt&md=0&dpid==DosenPekerjaanID=&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn&dsnsub1=DsnEdtPekerjaan\"><img src='img/edit.png' border=0>
      </a></td>
...
function TampilTelitiDsn1(){
  ...
  $lst->fields = "* ";
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn&dsnsub1=DsnEdtPenelitian'>Tambah Penelitian</td></tr>
    <tr>
	  <th class=ttl>#</th>
	  <th class=ttl>Edit</th>
  ...
  $lst->detailfmt = "<tr>
	  <td class=inp1 width=18 align=right>=NOMER=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/dosen&gos=DsnEdt&md=0&dlid==DosenPenelitianID=&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn&dsnsub1=DsnEdtPenelitian\"><img src='img/edit.png' border=0>
      </a></td>
...
function DsnEdtPenelitian() {
  ...
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen&gos=DsnEdt&dsnid=$_SESSION[dsnid]&dsnsub=TampilTelitiDsn'\"></td></tr>
  </form></table>";
}
...
function TampilPendidikan1(){
  ...
  $lst->headerfmt = "<p><table class=box cellspacing=1 cellpadding=4>
  	<td class=ul colspan=9><a href='?mnux=modules/dosen&gos=DsnEdt&md=1&dsnid=$_SESSION[dsnid]&dsnsub=TampilPendidikan&dsnsub1=DsnEdtPendidikan'>Tambah Pendidikan</td></tr>
    <tr>
	  <th class=ttl>#</th>
	  <th class=ttl>Edit</th>
  ...
  $lst->detailfmt = "<tr>
      ...
      <td class=cna=NA=><a href=\"?mnux=modules/dosen&gos=DsnEdt&md=0&dsnid=$_SESSION[dsnid]&dsnsub=TampilPendidikan&dsnsub1=DsnEdtPendidikan&DosenPendidikanID==DosenPendidikanID=\"><img src='img/edit.png' border=0>
      </a></td>
...
function DsnEdtPekerjaan() {
  ...
  <tr><td colspan=2><input type=submit name='submit' value='Simpan'>
    <input type=reset name='Reset' value='Reset'> 
	<input type=button name='batal' value='Batal' onClick=\"location='?mnux=modules/dosen&gos=DsnEdt&dsnid=$_SESSION[dsnid]&dsnsub=TampilKerjaDsn'\"></td></tr>
  </form></table>";
}
...
function DsnEdtPengajaran() {
  ...
  $lst->pageactive = "=PAGE=";
  $lst->pages = "<a href='?mnux=modules/dosen&gos=DsnEdt&dsnajarpage==PAGE='>=PAGE=</a>";
  $lst->tables = "jadwal j
