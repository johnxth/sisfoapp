...
function TampilkanCariDosen() {
  ...
  <input type=hidden name='mnux' value='modules/inq.dosen'>
...
function DftrDsn() {
  ...
  $lst->pageactive = "=PAGE=";
  $lst->pages = "<a href='?mnux=modules/inq.dosen&gos=&dsnpage==PAGE='>=PAGE=</a>";
  $lst->tables = "dosen
  ...
  $lst->detailfmt = "<tr>
      ...
      <td class=cna=NA=><a href=\"?mnux=modules/inq.dosen&gos=DsnDetail&dsnid==Login=\"><img src='img/edit.png' border=0>
      =Login=</a></td>
...
function TampilkanMenuDetailDosen($w) {
  ...
  for ($i = 0; $i < sizeof($arrMenuDosen); $i++) {
    ...
    echo "<td $c><a href='?mnux=modules/inq.dosen&gos=$mn[1]&dsnid=$w[Login]&dsndtl=$mn[2]'>$mn[0]</a></td>";
  }
  echo "</tr></table></p>";
}	  
...
function TampilkanHeaderDosen($w) {
  ...
  <tr><td class=ul>Pilihan:</td><td class=ul><a href='?mnux=modules/inq.dosen&gos=&sub='>Kembali ke Daftar Dosen</a></td></tr>
  </table></p>";
}
...
function TampilDetailKerjaDsn(){
  ...
  $lst->detailfmt = "<tr>
	  <td class=inp1 width=18 align=right>=NOMER=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/inq.dosen&gos=DsnDetail&md=0&dsnid=$_SESSION[dsnid]&dsndtl=DtlPekerjaan\"><img src='img/edit.png' border=0>
      </a></td>
...
function TampilDetailPendidikan(){
  ...
  $lst->detailfmt = "<tr>
	  <td class=inp1 width=18 align=right>=NOMER=</td>
      <td class=cna=NA=><a href=\"?mnux=modules/inq.dosen&gos=DsnDetail&dsnid=$_SESSION[dsnid]&dsndtl=DtlPendidikan\"><img src='img/edit.png' border=0>
      </a></td>
