...
function TampilkanHeader($w) {
  ...
  <tr><td class=ul>Pilihan</td><td class=ul><a href='?mnux=modules/me.mhsw.edt&mhswid=$w[MhswID]'>Kembali ke data mahasiswa</a></td></tr>
  </table></p>";
}
function TampilkanUploadFoto($w) {
  ...
  <input type=hidden name='mnux' value='modules/mhsw.foto'>
