...
function TampilkanHeaderKecil($w, $mnux='mhswkeu.det', $gos='', $pil=1) {
  ...
  $strpil = ($pil == 0) ? '' : "<tr><td class=ul colspan=2>Pilihan: <a href='?mnux=$mnux'>Kembali ke Daftar Mhsw</a> |
									...
									echo "<p>
											<table class=box cellspacing=2 cellpadding=4>
												<tr>
													<th class=ttl>Mahasiswa</th><th class=ttl>Program/Program Studi</th>
												</tr>
												<tr>
													<td class=ul>$w[MhswID]: <b>$w[Nama]</b>
												</td>
													<td class=ul><b>$w[PRG]</b> ($w[ProgramID]) - <b>$w[PRD]</b> ($w[ProdiID])</td>
												</tr>
										$strpil
									</td>
								</tr>
