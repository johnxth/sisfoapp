...
function DaftarUsr() {
	...
	<td><input type=button class='btn light' name='Dosen' value='Dosen' onclick=\"location='?mnux=modules/signup.mhsw&gos=UsrEdt&LevelID=$optdsn&md=1'\"></td>
	<td><input type=button class='btn light' name='Mahasiswa' value='Mahasiswa' onclick=\"location='?mnux=modules/signup.mhsw&gos=UsrEdt&LevelID=$optmhsw&md=1'\"></td>
	</tr></table></p>";
...
DaftarUsr();
  ...
  <tr><td colspan=2><input type=submit class='btn light' name='Simpan' value='Sign Up'>
  </form></table></p>";
}
function UsrSav() {
  $md = $_REQUEST['md']+0;
