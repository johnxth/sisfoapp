...
function CariPTDiktiScript() {
  ...
  <!--
  function caript(frm){
    lnk = "cariptdikti.php?PerguruanTinggiID="+frm.KodeHukum.value+"&Cari="+frm.Nama.value;
...
function IDEdt() {
  ...
  <tr><td $c1>Kode Hukum</td><td $c2><input type=text name='KodeHukum' value='$w[KodeHukum]' size=15 maxlength=10> <a href='javascript:caript(data)'>Cari</a></td></tr>
  <tr><td $c1>Nama</td><td $c2><input type=text name='Nama' value='$w[Nama]' size=50 maxlength=100></td></tr>
  ...
  <tr><td $c1>Tanggal Pengesahan</td><td $c2>$_TglSah</td></tr>
  ...
  <tr><td colspan=2><input type=submit name='Simpan' value='Simpan'>
    ...
    <input type=button name='Batal' value='Batal' onClick=\"location='?mnux=identitas&snm=$sid'\"></td></tr>
