...
function DaftarUsr() {
	...
	<select name='LevelID' onChange='this.form.submit()'>
	
	<option></option>
	<option><input type=button class='btn light' name='Dosen' value='Dosen' onChange=\"location='?mnux=modules/signup.mhsw.dosen&gos=UsrEdt&LevelID=$_SESSION[LevelID]&md=1'\"></option>
	<option><input type=button class='btn light' name='Mahasiswa' value='Mahasiswa' onChange=\"location='?mnux=modules/signup.mhsw.dosen&gos=UsrEdt&LevelID=$_SESSION[LevelID]&md=1'\"></option>
...
DaftarUsr();
  ...
  <tr><td colspan=2><input type=submit name='Simpan' value='Sign Up'>
  </form></table></p>";
}
function UsrSav() {
  $md = $_REQUEST['md']+0;
