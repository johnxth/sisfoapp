<?php
// Parameter
$_ProductName = "Sisfo Jurusan";
$_Institution = 'JURUSAN PENDIDIKAN TEKNIK ELEKTRO UPI';
$_Identitas = "E0451";
$_Version = "Bandung";
$_Author = "Eksansilus";
$_AuthorEmail = "oneofmilions@gmail.com";

// System
$_lf = "\r\n";
$_defmnux = 'login';
$_maxbaris = 30;
$_tmpdir = "D:\\1__SERVER\\xampp\\htdocs\\tmp";
$_templatedir = "C:\\apachefriends\\xampp\\htdocs\\template";
//$_kwitansipmb = "$_tmpdir\\kwitansipmb.dwoprn";
$_kwitansipmb = "tmp/kwitansipmb.xthprn";
$_FKartuUSM = "tmp/kartuusm.xthprn";
